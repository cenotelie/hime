...
namespace Hime.Tests.Executor
{
	...
	/// Represents a lexer
	/// </summary>
	[GeneratedCodeAttribute("Hime.SDK", "4.0.0")]
	internal class ExpectedTreeLexer : ContextSensitiveLexer
	{
		/// <summary>
		/// The automaton for this lexer
		/// </summary>
		private static readonly Automaton commonAutomaton = Automaton.Find(typeof(ExpectedTreeLexer), "ExpectedTreeLexer.bin");
		/// <summary>
		...
		public class ID
		{
			...
			/// </summary>
			public const int TerminalNodeName = 0x0062;
		}
		/// <summary>
		...
		public ExpectedTreeLexer(string input) : base(commonAutomaton, terminals, 0x0007, input) {}
		/// <summary>
		/// Initializes a new instance of the lexer
		/// </summary>
		/// <param name="input">The lexer's input</param>
		public ExpectedTreeLexer(TextReader input) : base(commonAutomaton, terminals, 0x0007, input) {}
	}
}
