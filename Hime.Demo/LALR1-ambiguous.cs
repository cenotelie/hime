namespace Analyzer
{
    ...
    public class AmbiguousLALR1_Parser : Hime.Redist.Parsers.BaseRNGLR1Parser
    {
        ...
        private static Rule[] p_StaticRules = {
           ...
           , new Rule(Production_19_0, new Hime.Redist.Parsers.SymbolVariable(0x19, "_Axiom_"))
 };
        private static State[] p_StaticStates = {
            new State(
               new string[29] {"[_Axiom_ -> . compilation_unit $]", "[compilation_unit -> . expression]", "[expression -> . exp_op12_conditional]", "[expression -> . exp_op13_assigment]", "[exp_op12_conditional -> . exp_op11]", "[exp_op13_assigment -> . exp_op1 = expression]", "[exp_op11 -> . exp_op2]", "[exp_op1 -> . exp_op0]", "[exp_op1 -> . exp_op1_cast]", "[exp_op2 -> . exp_op1]", "[exp_op2 -> . exp_op2 * exp_op1]", "[exp_op0 -> . exp_atom]", "[exp_op1_cast -> . ( type ) exp_op1]", "[exp_op1 -> . exp_op0]", "[exp_op1 -> . exp_op1_cast]", "[exp_op2 -> . exp_op1]", "[exp_op2 -> . exp_op2 * exp_op1]", "[exp_atom -> . IDENTIFIER]", "[exp_atom -> . ( expression )]", "[exp_op0 -> . exp_atom]", "[exp_op1_cast -> . ( type ) exp_op1]", "[exp_op1 -> . exp_op0]", "[exp_op1 -> . exp_op1_cast]", "[exp_atom -> . IDENTIFIER]", "[exp_atom -> . ( expression )]", "[exp_op0 -> . exp_atom]", "[exp_op1_cast -> . ( type ) exp_op1]", "[exp_atom -> . IDENTIFIER]", "[exp_atom -> . ( expression )]"},
            ...
            , new State(
               new string[1] {"[_Axiom_ -> compilation_unit . $]"},
            ...
            , new State(
               ...
               new Terminal[3] {new Terminal("$", 0x2), new Terminal("_T[*]", 0x17), new Terminal("_T[=]", 0x18)},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {{ 0x18, 0xE }},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.List<Reduction>() {new Reduction(0x2, p_StaticRules[0x8], 0x1, p_StaticNullChoicesSPPF[0x0]), new Reduction(0x17, p_StaticRules[0x8], 0x1, p_StaticNullChoicesSPPF[0x0])})
            , new State(
               new string[3] {"[exp_op11 -> exp_op2 . ]", "[exp_op2 -> exp_op2 . * exp_op1]", "[exp_op2 -> exp_op2 . * exp_op1]"},
               new Terminal[2] {new Terminal("$", 0x2), new Terminal("_T[*]", 0x17)},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {{ 0x17, 0xF }},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
            ...
            , new State(
               ...
               new Terminal[3] {new Terminal("_T[=]", 0x18), new Terminal("$", 0x2), new Terminal("_T[*]", 0x17)},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.List<Reduction>() {new Reduction(0x18, p_StaticRules[0x6], 0x1, p_StaticNullChoicesSPPF[0x0]), new Reduction(0x2, p_StaticRules[0x6], 0x1, p_StaticNullChoicesSPPF[0x0]), new Reduction(0x17, p_StaticRules[0x6], 0x1, p_StaticNullChoicesSPPF[0x0])})
            , new State(
               new string[3] {"[exp_op1 -> exp_op1_cast . ]", "[exp_op1 -> exp_op1_cast . ]", "[exp_op1 -> exp_op1_cast . ]"},
               new Terminal[3] {new Terminal("_T[=]", 0x18), new Terminal("$", 0x2), new Terminal("_T[*]", 0x17)},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.List<Reduction>() {new Reduction(0x18, p_StaticRules[0x7], 0x1, p_StaticNullChoicesSPPF[0x0]), new Reduction(0x2, p_StaticRules[0x7], 0x1, p_StaticNullChoicesSPPF[0x0]), new Reduction(0x17, p_StaticRules[0x7], 0x1, p_StaticNullChoicesSPPF[0x0])})
            , new State(
               new string[3] {"[exp_op0 -> exp_atom . ]", "[exp_op0 -> exp_atom . ]", "[exp_op0 -> exp_atom . ]"},
               new Terminal[3] {new Terminal("_T[=]", 0x18), new Terminal("$", 0x2), new Terminal("_T[*]", 0x17)},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.List<Reduction>() {new Reduction(0x18, p_StaticRules[0x4], 0x1, p_StaticNullChoicesSPPF[0x0]), new Reduction(0x2, p_StaticRules[0x4], 0x1, p_StaticNullChoicesSPPF[0x0]), new Reduction(0x17, p_StaticRules[0x4], 0x1, p_StaticNullChoicesSPPF[0x0])})
            , new State(
            ...
            , new State(
               ...
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.List<Reduction>() {new Reduction(0x18, p_StaticRules[0x2], 0x1, p_StaticNullChoicesSPPF[0x0]), new Reduction(0x2, p_StaticRules[0x2], 0x1, p_StaticNullChoicesSPPF[0x0]), new Reduction(0x17, p_StaticRules[0x2], 0x1, p_StaticNullChoicesSPPF[0x0])})
            , new State(
               new string[1] {"[_Axiom_ -> compilation_unit $ . ]"},
            ...
            , new State(
               ...
               new Terminal[4] {new Terminal("_T[)]", 0x14), new Terminal("_T[=]", 0x18), new Terminal("_T[*]", 0x17), new Terminal("_T[.]", 0x11)},
               ...
               new System.Collections.Generic.List<Reduction>() {new Reduction(0x14, p_StaticRules[0x0], 0x1, p_StaticNullChoicesSPPF[0x1]), new Reduction(0x18, p_StaticRules[0x2], 0x1, p_StaticNullChoicesSPPF[0x0]), new Reduction(0x14, p_StaticRules[0x2], 0x1, p_StaticNullChoicesSPPF[0x0]), new Reduction(0x17, p_StaticRules[0x2], 0x1, p_StaticNullChoicesSPPF[0x0]), new Reduction(0x14, p_StaticRules[0x11], 0x0, p_StaticNullChoicesSPPF[0x0])})
            , new State(
               new string[1] {"[exp_op12_conditional -> exp_op11 . ]"},
               new Terminal[1] {new Terminal("_T[)]", 0x14)},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
            ...
            , new State(
               new string[3] {"[exp_op13_assigment -> exp_op1 . = expression]", "[exp_op2 -> exp_op1 . ]", "[exp_op2 -> exp_op1 . ]"},
               new Terminal[3] {new Terminal("_T[)]", 0x14), new Terminal("_T[*]", 0x17), new Terminal("_T[=]", 0x18)},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {{ 0x18, 0x28 }},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.List<Reduction>() {new Reduction(0x14, p_StaticRules[0x8], 0x1, p_StaticNullChoicesSPPF[0x0]), new Reduction(0x17, p_StaticRules[0x8], 0x1, p_StaticNullChoicesSPPF[0x0])})
            , new State(
               new string[3] {"[exp_op11 -> exp_op2 . ]", "[exp_op2 -> exp_op2 . * exp_op1]", "[exp_op2 -> exp_op2 . * exp_op1]"},
               new Terminal[2] {new Terminal("_T[)]", 0x14), new Terminal("_T[*]", 0x17)},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {{ 0x17, 0x29 }},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.List<Reduction>() {new Reduction(0x14, p_StaticRules[0xA], 0x1, p_StaticNullChoicesSPPF[0x0])})
            , new State(
               new string[3] {"[exp_op1 -> exp_op0 . ]", "[exp_op1 -> exp_op0 . ]", "[exp_op1 -> exp_op0 . ]"},
               new Terminal[3] {new Terminal("_T[=]", 0x18), new Terminal("_T[)]", 0x14), new Terminal("_T[*]", 0x17)},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.List<Reduction>() {new Reduction(0x18, p_StaticRules[0x6], 0x1, p_StaticNullChoicesSPPF[0x0]), new Reduction(0x14, p_StaticRules[0x6], 0x1, p_StaticNullChoicesSPPF[0x0]), new Reduction(0x17, p_StaticRules[0x6], 0x1, p_StaticNullChoicesSPPF[0x0])})
            , new State(
               new string[3] {"[exp_op1 -> exp_op1_cast . ]", "[exp_op1 -> exp_op1_cast . ]", "[exp_op1 -> exp_op1_cast . ]"},
               new Terminal[3] {new Terminal("_T[=]", 0x18), new Terminal("_T[)]", 0x14), new Terminal("_T[*]", 0x17)},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.List<Reduction>() {new Reduction(0x18, p_StaticRules[0x7], 0x1, p_StaticNullChoicesSPPF[0x0]), new Reduction(0x14, p_StaticRules[0x7], 0x1, p_StaticNullChoicesSPPF[0x0]), new Reduction(0x17, p_StaticRules[0x7], 0x1, p_StaticNullChoicesSPPF[0x0])})
            , new State(
               new string[3] {"[exp_op0 -> exp_atom . ]", "[exp_op0 -> exp_atom . ]", "[exp_op0 -> exp_atom . ]"},
               new Terminal[3] {new Terminal("_T[=]", 0x18), new Terminal("_T[)]", 0x14), new Terminal("_T[*]", 0x17)},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.List<Reduction>() {new Reduction(0x18, p_StaticRules[0x4], 0x1, p_StaticNullChoicesSPPF[0x0]), new Reduction(0x14, p_StaticRules[0x4], 0x1, p_StaticNullChoicesSPPF[0x0]), new Reduction(0x17, p_StaticRules[0x4], 0x1, p_StaticNullChoicesSPPF[0x0])})
            , new State(
               new string[35] {"[exp_op1_cast -> ( . type ) exp_op1]", "[exp_atom -> ( . expression )]", "[exp_op1_cast -> ( . type ) exp_op1]", "[exp_atom -> ( . expression )]", "[exp_op1_cast -> ( . type ) exp_op1]", "[exp_atom -> ( . expression )]", "[type -> . qualified_name]", "[expression -> . exp_op12_conditional]", "[expression -> . exp_op13_assigment]", "[qualified_name -> . IDENTIFIER _m18]", "[exp_op12_conditional -> . exp_op11]", "[exp_op13_assigment -> . exp_op1 = expression]", "[exp_op11 -> . exp_op2]", "[exp_op1 -> . exp_op0]", "[exp_op1 -> . exp_op1_cast]", "[exp_op2 -> . exp_op1]", "[exp_op2 -> . exp_op2 * exp_op1]", "[exp_op0 -> . exp_atom]", "[exp_op1_cast -> . ( type ) exp_op1]", "[exp_op1 -> . exp_op0]", "[exp_op1 -> . exp_op1_cast]", "[exp_op2 -> . exp_op1]", "[exp_op2 -> . exp_op2 * exp_op1]", "[exp_atom -> . IDENTIFIER]", "[exp_atom -> . ( expression )]", "[exp_op0 -> . exp_atom]", "[exp_op1_cast -> . ( type ) exp_op1]", "[exp_op1 -> . exp_op0]", "[exp_op1 -> . exp_op1_cast]", "[exp_atom -> . IDENTIFIER]", "[exp_atom -> . ( expression )]", "[exp_op0 -> . exp_atom]", "[exp_op1_cast -> . ( type ) exp_op1]", "[exp_atom -> . IDENTIFIER]", "[exp_atom -> . ( expression )]"},
               new Terminal[2] {new Terminal("IDENTIFIER", 0x4), new Terminal("_T[(]", 0x13)},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {{ 0x4, 0x15 }, { 0x13, 0x1C }},
            ...
            , new State(
               ...
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.List<Reduction>() {new Reduction(0x2, p_StaticRules[0x9], 0x3, p_StaticNullChoicesSPPF[0x0]), new Reduction(0x17, p_StaticRules[0x9], 0x3, p_StaticNullChoicesSPPF[0x0])})
            , new State(
               new string[2] {"[exp_op1 -> exp_op0 . ]", "[exp_op1 -> exp_op0 . ]"},
               new Terminal[2] {new Terminal("$", 0x2), new Terminal("_T[*]", 0x17)},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.List<Reduction>() {new Reduction(0x2, p_StaticRules[0x6], 0x1, p_StaticNullChoicesSPPF[0x0]), new Reduction(0x17, p_StaticRules[0x6], 0x1, p_StaticNullChoicesSPPF[0x0])})
            , new State(
               new string[2] {"[exp_op1 -> exp_op1_cast . ]", "[exp_op1 -> exp_op1_cast . ]"},
               new Terminal[2] {new Terminal("$", 0x2), new Terminal("_T[*]", 0x17)},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.List<Reduction>() {new Reduction(0x2, p_StaticRules[0x7], 0x1, p_StaticNullChoicesSPPF[0x0]), new Reduction(0x17, p_StaticRules[0x7], 0x1, p_StaticNullChoicesSPPF[0x0])})
            , new State(
               new string[2] {"[exp_op0 -> exp_atom . ]", "[exp_op0 -> exp_atom . ]"},
               new Terminal[2] {new Terminal("$", 0x2), new Terminal("_T[*]", 0x17)},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.List<Reduction>() {new Reduction(0x2, p_StaticRules[0x4], 0x1, p_StaticNullChoicesSPPF[0x0]), new Reduction(0x17, p_StaticRules[0x4], 0x1, p_StaticNullChoicesSPPF[0x0])})
            , new State(
            ...
            , new State(
               ...
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.List<Reduction>() {new Reduction(0x2, p_StaticRules[0x2], 0x1, p_StaticNullChoicesSPPF[0x0]), new Reduction(0x17, p_StaticRules[0x2], 0x1, p_StaticNullChoicesSPPF[0x0])})
            , new State(
            ...
            , new State(
               ...
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.List<Reduction>() {new Reduction(0x18, p_StaticRules[0x3], 0x3, p_StaticNullChoicesSPPF[0x0]), new Reduction(0x2, p_StaticRules[0x3], 0x3, p_StaticNullChoicesSPPF[0x0]), new Reduction(0x17, p_StaticRules[0x3], 0x3, p_StaticNullChoicesSPPF[0x0])})
            , new State(
            ...
            , new State(
               ...
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.List<Reduction>() {new Reduction(0x18, p_StaticRules[0x5], 0x4, p_StaticNullChoicesSPPF[0x0]), new Reduction(0x2, p_StaticRules[0x5], 0x4, p_StaticNullChoicesSPPF[0x0]), new Reduction(0x17, p_StaticRules[0x5], 0x4, p_StaticNullChoicesSPPF[0x0])})
            , new State(
            ...
            , new State(
               ...
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.List<Reduction>() {new Reduction(0x18, p_StaticRules[0x2], 0x1, p_StaticNullChoicesSPPF[0x0]), new Reduction(0x14, p_StaticRules[0x2], 0x1, p_StaticNullChoicesSPPF[0x0]), new Reduction(0x17, p_StaticRules[0x2], 0x1, p_StaticNullChoicesSPPF[0x0])})
            , new State(
               new string[2] {"[exp_op2 -> exp_op2 * exp_op1 . ]", "[exp_op2 -> exp_op2 * exp_op1 . ]"},
               new Terminal[2] {new Terminal("_T[)]", 0x14), new Terminal("_T[*]", 0x17)},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.List<Reduction>() {new Reduction(0x14, p_StaticRules[0x9], 0x3, p_StaticNullChoicesSPPF[0x0]), new Reduction(0x17, p_StaticRules[0x9], 0x3, p_StaticNullChoicesSPPF[0x0])})
            , new State(
               new string[2] {"[exp_op1 -> exp_op0 . ]", "[exp_op1 -> exp_op0 . ]"},
               new Terminal[2] {new Terminal("_T[)]", 0x14), new Terminal("_T[*]", 0x17)},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.List<Reduction>() {new Reduction(0x14, p_StaticRules[0x6], 0x1, p_StaticNullChoicesSPPF[0x0]), new Reduction(0x17, p_StaticRules[0x6], 0x1, p_StaticNullChoicesSPPF[0x0])})
            , new State(
               new string[2] {"[exp_op1 -> exp_op1_cast . ]", "[exp_op1 -> exp_op1_cast . ]"},
               new Terminal[2] {new Terminal("_T[)]", 0x14), new Terminal("_T[*]", 0x17)},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.List<Reduction>() {new Reduction(0x14, p_StaticRules[0x7], 0x1, p_StaticNullChoicesSPPF[0x0]), new Reduction(0x17, p_StaticRules[0x7], 0x1, p_StaticNullChoicesSPPF[0x0])})
            , new State(
               new string[2] {"[exp_op0 -> exp_atom . ]", "[exp_op0 -> exp_atom . ]"},
               new Terminal[2] {new Terminal("_T[)]", 0x14), new Terminal("_T[*]", 0x17)},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.List<Reduction>() {new Reduction(0x14, p_StaticRules[0x4], 0x1, p_StaticNullChoicesSPPF[0x0]), new Reduction(0x17, p_StaticRules[0x4], 0x1, p_StaticNullChoicesSPPF[0x0])})
            , new State(
               new string[33] {"[exp_op1_cast -> ( . type ) exp_op1]", "[exp_op1_cast -> ( . type ) exp_op1]", "[exp_atom -> ( . expression )]", "[exp_atom -> ( . expression )]", "[type -> . qualified_name]", "[expression -> . exp_op12_conditional]", "[expression -> . exp_op13_assigment]", "[qualified_name -> . IDENTIFIER _m18]", "[exp_op12_conditional -> . exp_op11]", "[exp_op13_assigment -> . exp_op1 = expression]", "[exp_op11 -> . exp_op2]", "[exp_op1 -> . exp_op0]", "[exp_op1 -> . exp_op1_cast]", "[exp_op2 -> . exp_op1]", "[exp_op2 -> . exp_op2 * exp_op1]", "[exp_op0 -> . exp_atom]", "[exp_op1_cast -> . ( type ) exp_op1]", "[exp_op1 -> . exp_op0]", "[exp_op1 -> . exp_op1_cast]", "[exp_op2 -> . exp_op1]", "[exp_op2 -> . exp_op2 * exp_op1]", "[exp_atom -> . IDENTIFIER]", "[exp_atom -> . ( expression )]", "[exp_op0 -> . exp_atom]", "[exp_op1_cast -> . ( type ) exp_op1]", "[exp_op1 -> . exp_op0]", "[exp_op1 -> . exp_op1_cast]", "[exp_atom -> . IDENTIFIER]", "[exp_atom -> . ( expression )]", "[exp_op0 -> . exp_atom]", "[exp_op1_cast -> . ( type ) exp_op1]", "[exp_atom -> . IDENTIFIER]", "[exp_atom -> . ( expression )]"},
               new Terminal[2] {new Terminal("IDENTIFIER", 0x4), new Terminal("_T[(]", 0x13)},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {{ 0x4, 0x15 }, { 0x13, 0x1C }},
            ...
            , new State(
               ...
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.List<Reduction>() {new Reduction(0x14, p_StaticRules[0x2], 0x1, p_StaticNullChoicesSPPF[0x0]), new Reduction(0x17, p_StaticRules[0x2], 0x1, p_StaticNullChoicesSPPF[0x0])})
            , new State(
               new string[21] {"[exp_op1_cast -> ( type ) . exp_op1]", "[exp_op1_cast -> ( type ) . exp_op1]", "[exp_op1_cast -> ( type ) . exp_op1]", "[exp_op1 -> . exp_op0]", "[exp_op1 -> . exp_op1_cast]", "[exp_op1 -> . exp_op0]", "[exp_op1 -> . exp_op1_cast]", "[exp_op1 -> . exp_op0]", "[exp_op1 -> . exp_op1_cast]", "[exp_op0 -> . exp_atom]", "[exp_op1_cast -> . ( type ) exp_op1]", "[exp_op0 -> . exp_atom]", "[exp_op1_cast -> . ( type ) exp_op1]", "[exp_op0 -> . exp_atom]", "[exp_op1_cast -> . ( type ) exp_op1]", "[exp_atom -> . IDENTIFIER]", "[exp_atom -> . ( expression )]", "[exp_atom -> . IDENTIFIER]", "[exp_atom -> . ( expression )]", "[exp_atom -> . IDENTIFIER]", "[exp_atom -> . ( expression )]"},
               new Terminal[2] {new Terminal("_T[(]", 0x13), new Terminal("IDENTIFIER", 0x4)},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {{ 0x13, 0x1C }, { 0x4, 0x31 }},
            ...
            , new State(
               ...
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.List<Reduction>() {new Reduction(0x18, p_StaticRules[0x3], 0x3, p_StaticNullChoicesSPPF[0x0]), new Reduction(0x14, p_StaticRules[0x3], 0x3, p_StaticNullChoicesSPPF[0x0]), new Reduction(0x17, p_StaticRules[0x3], 0x3, p_StaticNullChoicesSPPF[0x0])})
            , new State(
            ...
            , new State(
               ...
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.List<Reduction>() {new Reduction(0x2, p_StaticRules[0x3], 0x3, p_StaticNullChoicesSPPF[0x0]), new Reduction(0x17, p_StaticRules[0x3], 0x3, p_StaticNullChoicesSPPF[0x0])})
            , new State(
               new string[1] {"[_m18 -> . IDENTIFIER _m18 . ]"},
               new Terminal[1] {new Terminal("_T[)]", 0x14)},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
            ...
            , new State(
               ...
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.List<Reduction>() {new Reduction(0x18, p_StaticRules[0x5], 0x4, p_StaticNullChoicesSPPF[0x0]), new Reduction(0x14, p_StaticRules[0x5], 0x4, p_StaticNullChoicesSPPF[0x0]), new Reduction(0x17, p_StaticRules[0x5], 0x4, p_StaticNullChoicesSPPF[0x0])})
            , new State(
               new string[2] {"[exp_op1_cast -> ( type ) exp_op1 . ]", "[exp_op1_cast -> ( type ) exp_op1 . ]"},
               new Terminal[2] {new Terminal("$", 0x2), new Terminal("_T[*]", 0x17)},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.List<Reduction>() {new Reduction(0x2, p_StaticRules[0x5], 0x4, p_StaticNullChoicesSPPF[0x0]), new Reduction(0x17, p_StaticRules[0x5], 0x4, p_StaticNullChoicesSPPF[0x0])})
            , new State(
               new string[14] {"[exp_op1_cast -> ( type ) . exp_op1]", "[exp_op1_cast -> ( type ) . exp_op1]", "[exp_op1 -> . exp_op0]", "[exp_op1 -> . exp_op1_cast]", "[exp_op1 -> . exp_op0]", "[exp_op1 -> . exp_op1_cast]", "[exp_op0 -> . exp_atom]", "[exp_op1_cast -> . ( type ) exp_op1]", "[exp_op0 -> . exp_atom]", "[exp_op1_cast -> . ( type ) exp_op1]", "[exp_atom -> . IDENTIFIER]", "[exp_atom -> . ( expression )]", "[exp_atom -> . IDENTIFIER]", "[exp_atom -> . ( expression )]"},
               new Terminal[2] {new Terminal("_T[(]", 0x13), new Terminal("IDENTIFIER", 0x4)},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {{ 0x13, 0x36 }, { 0x4, 0x37 }},
            ...
            , new State(
               ...
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.List<Reduction>() {new Reduction(0x14, p_StaticRules[0x3], 0x3, p_StaticNullChoicesSPPF[0x0]), new Reduction(0x17, p_StaticRules[0x3], 0x3, p_StaticNullChoicesSPPF[0x0])})
            , new State(
               new string[2] {"[exp_op1_cast -> ( type ) exp_op1 . ]", "[exp_op1_cast -> ( type ) exp_op1 . ]"},
               new Terminal[2] {new Terminal("_T[)]", 0x14), new Terminal("_T[*]", 0x17)},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.Dictionary<ushort, ushort>() {},
               new System.Collections.Generic.List<Reduction>() {new Reduction(0x14, p_StaticRules[0x5], 0x4, p_StaticNullChoicesSPPF[0x0]), new Reduction(0x17, p_StaticRules[0x5], 0x4, p_StaticNullChoicesSPPF[0x0])})
 };
