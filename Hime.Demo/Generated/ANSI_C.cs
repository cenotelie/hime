...
namespace Analyser
{
    class ANSI_C_Lexer : LexerText
    {
        public static readonly SymbolTerminal[] terminals = {
            ...
            new SymbolTerminal("IDENTIFIER", 0x8),
            new SymbolTerminal("REAL_LITTERAL_SUFFIX", 0xF),
            new SymbolTerminal("INTEGER_LITTERAL_DECIMAL", 0xD),
            ...
            new SymbolTerminal("INTEGER_LITTERAL_SUFFIX", 0xC),
            new SymbolTerminal("{", 0x8C),
            new SymbolTerminal("}", 0x8D),
            new SymbolTerminal("SEPARATOR", 0x7),
            new SymbolTerminal("/=", 0x74),
            new SymbolTerminal("REAL_LITTERAL", 0x10),
            new SymbolTerminal("STRING_LITERAL", 0x12),
            ...
            new SymbolTerminal("if", 0x96),
            new SymbolTerminal("do", 0x9A),
            new SymbolTerminal("for", 0x9B),
            new SymbolTerminal("INTEGER_LITTERAL_HEXA", 0xE),
            new SymbolTerminal("CHARACTER_LITTERAL", 0x11),
            new SymbolTerminal("...", 0x93),
            new SymbolTerminal("<<=", 0x78),
            new SymbolTerminal(">>=", 0x79),
            new SymbolTerminal("int", 0x86),
            new SymbolTerminal("NULL_LITTERAL", 0x9),
            new SymbolTerminal("BOOLEAN_LITTERAL_TRUE", 0xA),
            new SymbolTerminal("enum", 0x90),
            new SymbolTerminal("else", 0x97),
            new SymbolTerminal("auto", 0x81),
            new SymbolTerminal("void", 0x83),
            new SymbolTerminal("char", 0x84),
            new SymbolTerminal("case", 0x94),
            new SymbolTerminal("long", 0x87),
            new SymbolTerminal("goto", 0x9C),
            new SymbolTerminal("BOOLEAN_LITTERAL_FALSE", 0xB),
            new SymbolTerminal("float", 0x88),
            new SymbolTerminal("short", 0x85),
            new SymbolTerminal("const", 0x91),
            new SymbolTerminal("union", 0x8F),
            new SymbolTerminal("while", 0x99),
            new SymbolTerminal("break", 0x9E),
            new SymbolTerminal("sizeof", 0x5B),
            new SymbolTerminal("signed", 0x8A),
            new SymbolTerminal("static", 0x80),
            new SymbolTerminal("struct", 0x8E),
            new SymbolTerminal("switch", 0x98),
            new SymbolTerminal("extern", 0x7F),
            new SymbolTerminal("return", 0x9F),
            new SymbolTerminal("double", 0x89),
            new SymbolTerminal("typedef", 0x7E),
            new SymbolTerminal("default", 0x95),
            new SymbolTerminal("register", 0x82),
            new SymbolTerminal("volatile", 0x92),
            new SymbolTerminal("continue", 0x9D),
            new SymbolTerminal("unsigned", 0x8B) };
