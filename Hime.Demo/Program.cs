namespace LangTest
{
    ...
    {        
        ...
        static void Main(string[] args)
        {
            ...
            //Hime.Parsers.CompilationTask Task = Hime.Parsers.CompilationTask.Create(new string[] { "Languages\\Earth.CIL.CSharp.gram" }, "Hime.Earth.CIL.GrammarCSharp", Hime.Parsers.ParsingMethod.LRStar, "Analyser", null, "GrammarCSharp.cs", true, true);
            Task.Execute();
            //Parse_Test();
        }
