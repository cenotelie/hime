...
{
    [TestFixture]
    public class Suite00_Ambiguous : BaseTestSuite
    {
    	[Test]
        ...
        {
            Assert.IsTrue(CompileResource("AmbiguousLR1.gram", ParsingMethod.LALR1).HasErrors);
        }

        [Test]
        public void Test008_FindsAmbigousGrammarLR1()
        {
            Assert.IsTrue(CompileResource("AmbiguousLR1.gram", ParsingMethod.LR1).HasErrors);
        }
