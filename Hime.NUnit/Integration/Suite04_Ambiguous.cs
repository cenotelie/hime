...
namespace Hime.NUnit.Integration
{
    ...
    public class Suite04_Ambiguous : BaseTestSuite
    {
        ...
        public void Test001_ConflictuousGrammar_LALR1()
        {
            ...
            Assert.IsTrue(CompileRaw(grammar, EParsingMethod.LALR1).HasErrors);
        }
        ...
        {
            string grammar = "public cf text grammar Test { options{ Axiom=\"test\"; } terminals{} rules{ test->a|b; a->'x'; b->'x'; }  }";
            Assert.IsTrue(CompileRaw(grammar, EParsingMethod.LR1).HasErrors);
        }
        ...
        public void Test003_FindsLALR1AmbiguousAndLR1NonAmbiguous()
        {
            ...
            Assert.IsTrue(CompileRaw(grammar, EParsingMethod.LALR1).HasErrors);
            Assert.IsFalse(CompileRaw(grammar, EParsingMethod.LR1).HasErrors);
        }
        ...
        {
            Assert.IsTrue(CompileResource("AmbiguousLR1.gram", EParsingMethod.LALR1).HasErrors);
        }

        [Test]
        public void Test008_FindsAmbigousGrammarLR1()
        {
            Assert.IsTrue(CompileResource("AmbiguousLR1.gram", EParsingMethod.LR1).HasErrors);
        }
        ...
        public void Test009_ShouldAcceptWhenNoTerminalsArePresent_Item415()
        {
            ...
            Assert.IsFalse(CompileRaw(grammar, EParsingMethod.LR0).HasErrors);
        }
