                        ...
                        for (int s2 = 0; s2 != backend.Count; s2++)
                        {
                            for (int t2 = 0; t2 != backend[s2].Transitions.Count; t2++)
                            {
                                ...
                                if ((s1 != s2) || (t1 != t2))
                                {
                                    ...
                                    if (Part1.Length != 0) backend[s1].AddTransition(Part1, backend[s1].Transitions[t1].Next);
                                    if (Part2.Length != 0) backend[s1].AddTransition(Part2, backend[s1].Transitions[t1].Next);
                                    ...
                                    if (Part1.Length != 0) backend[s2].AddTransition(Part1, backend[s2].Transitions[t2].Next);
                                    if (Part2.Length != 0) backend[s2].AddTransition(Part2, backend[s2].Transitions[t2].Next);
                                    modification = true;
                                }
                            }
                        }
