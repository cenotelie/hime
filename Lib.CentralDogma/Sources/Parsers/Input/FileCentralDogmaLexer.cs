...
namespace Hime.Parsers.Input
{
    public class FileCentralDogmaLexer : LexerText
    {
        public static readonly SymbolTerminal[] terminals = {
            ...
            new SymbolTerminal(0x96, "["),
            new SymbolTerminal(0x17, "INTEGER"),
            ...
            new SymbolTerminal(0x30, ">"),
            new SymbolTerminal(0x31, "^"),
            new SymbolTerminal(0x32, "!"),
            new SymbolTerminal(0xA, "NAME"),
            new SymbolTerminal(0x36, ":"),
            new SymbolTerminal(0x97, "]"),
            new SymbolTerminal(0x7, "SEPARATOR"),
            new SymbolTerminal(0x22, ".."),
            new SymbolTerminal(0x18, "QUOTED_DATA"),
            new SymbolTerminal(0x19, "ESCAPEES"),
            new SymbolTerminal(0x2D, "=>"),
            new SymbolTerminal(0x2E, "->"),
            new SymbolTerminal(0x37, "cf"),
            new SymbolTerminal(0x98, "cs"),
            new SymbolTerminal(0x1A, "SYMBOL_TERMINAL_TEXT"),
            new SymbolTerminal(0x1B, "SYMBOL_TERMINAL_SET"),
            new SymbolTerminal(0x1E, "SYMBOL_VALUE_UINT8"),
            new SymbolTerminal(0x35, "rules"),
            new SymbolTerminal(0x1C, "SYMBOL_TERMINAL_UBLOCK"),
            new SymbolTerminal(0x1D, "SYMBOL_TERMINAL_UCAT"),
            new SymbolTerminal(0x1F, "SYMBOL_VALUE_UINT16"),
            new SymbolTerminal(0x33, "options"),
            new SymbolTerminal(0x38, "grammar"),
            new SymbolTerminal(0x34, "terminals") };
        private static LexerDFAState[] staticStates = { 
            new LexerDFAState(new ushort[][] {
                ...
                new ushort[3] { 0x5B, 0x5B, 0x20 },
                new ushort[3] { 0x5C, 0x5C, 0x5 },
                new ushort[3] { 0x30, 0x30, 0x21 },
                new ushort[3] { 0x3D, 0x3D, 0x23 },
                new ushort[3] { 0x3B, 0x3B, 0x24 },
