...
(export FrameworkPathOverride="$MONO20"; dotnet pack "$ROOT/sdk-net" -c Release)
...
cp "$ROOT/sdk-net/bin/Release/Hime.SDK.$VERSION.nupkg"                          "$RELENG/hime-$VERSION/nuget/Hime.SDK.$VERSION.nupkg"
cp "$ROOT/sdk-net/bin/Release/Hime.SDK.$VERSION.symbols.nupkg"                  "$RELENG/hime-$VERSION/nuget/Hime.SDK.$VERSION.symbols.nupkg"
...
cp "$ROOT/parseit-net/bin/Release/net20/publish/parseit.exe"                    "$RELENG/hime-$VERSION/net20/parseit.exe"
cp "$ROOT/parseit-net/bin/Release/net20/publish/parseit.pdb"                    "$RELENG/hime-$VERSION/net20/parseit.pdb"
cp "$ROOT/runtime-net/bin/Release/net20/Hime.Redist.xml"                        "$RELENG/hime-$VERSION/net20/Hime.Redist.xml"
cp "$ROOT/sdk-net/bin/Release/net20/Hime.SDK.xml"                               "$RELENG/hime-$VERSION/net20/Hime.SDK.xml"
...
cp "$ROOT/parseit-net/bin/Release/net461/publish/parseit.exe"                   "$RELENG/hime-$VERSION/net461/parseit.exe"
cp "$ROOT/parseit-net/bin/Release/net461/publish/parseit.pdb"                   "$RELENG/hime-$VERSION/net461/parseit.pdb"
cp "$ROOT/runtime-net/bin/Release/net20/Hime.Redist.xml"                        "$RELENG/hime-$VERSION/net461/Hime.Redist.xml"
cp "$ROOT/sdk-net/bin/Release/net20/Hime.SDK.xml"                               "$RELENG/hime-$VERSION/net461/Hime.SDK.xml"
...
cp "$ROOT/parseit-net/bin/Release/netcoreapp2.0/publish/parseit.dll"                "$RELENG/hime-$VERSION/netcore20/parseit.dll"
cp "$ROOT/parseit-net/bin/Release/netcoreapp2.0/publish/parseit.pdb"                "$RELENG/hime-$VERSION/netcore20/parseit.pdb"
cp "$ROOT/parseit-net/bin/Release/netcoreapp2.0/publish/parseit.deps.json"          "$RELENG/hime-$VERSION/netcore20/parseit.deps.json"
cp "$ROOT/parseit-net/bin/Release/netcoreapp2.0/publish/parseit.runtimeconfig.json" "$RELENG/hime-$VERSION/netcore20/parseit.runtimeconfig.json"
