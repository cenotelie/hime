...
(export FrameworkPathOverride="$MONO20"; dotnet pack "$ROOT/cli" -c Release)
...
(export FrameworkPathOverride="$MONO20"; dotnet publish "$ROOT/parseit" -c Release -f net20)
...
cp "$ROOT/cli/bin/Release/Hime.CLI.$VERSION.nupkg"                              "$RELENG/hime-$VERSION/nuget/Hime.CLI.$VERSION.nupkg"
cp "$ROOT/cli/bin/Release/Hime.CLI.$VERSION.symbols.nupkg"                      "$RELENG/hime-$VERSION/nuget/Hime.CLI.$VERSION.symbols.nupkg"
...
cp "$ROOT/himecc/bin/Release/net20/publish/Hime.CLI.dll"                        "$RELENG/hime-$VERSION/net20/Hime.CLI.dll"
cp "$ROOT/himecc/bin/Release/net20/publish/Hime.CLI.pdb"                        "$RELENG/hime-$VERSION/net20/Hime.CLI.pdb"
...
cp "$ROOT/cli/bin/Release/net20/Hime.CLI.xml"                                   "$RELENG/hime-$VERSION/net20/Hime.CLI.xml"
...
cp "$ROOT/himecc/bin/Release/net461/publish/Hime.CLI.dll"                       "$RELENG/hime-$VERSION/net461/Hime.CLI.dll"
cp "$ROOT/himecc/bin/Release/net461/publish/Hime.CLI.pdb"                       "$RELENG/hime-$VERSION/net461/Hime.CLI.pdb"
...
cp "$ROOT/cli/bin/Release/net20/Hime.CLI.xml"                                   "$RELENG/hime-$VERSION/net461/Hime.CLI.xml"
...
cp "$ROOT/himecc/bin/Release/netcoreapp2.0/publish/Hime.CLI.dll"                "$RELENG/hime-$VERSION/netcore20/Hime.CLI.dll"
cp "$ROOT/himecc/bin/Release/netcoreapp2.0/publish/Hime.CLI.pdb"                "$RELENG/hime-$VERSION/netcore20/Hime.CLI.pdb"
...
cp "$ROOT/cli/bin/Release/netstandard2.0/Hime.CLI.xml"                          "$RELENG/hime-$VERSION/netcore20/Hime.CLI.xml"
