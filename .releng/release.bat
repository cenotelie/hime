...
dotnet publish "%ROOT%\himecc" -c Release -f net461
dotnet publish "%ROOT%\parseit" -c Release -f net461
dotnet publish "%ROOT%\parseit" -c Release -f netcoreapp2.0
ECHO -- Building Hime Redist for Java --
CALL mvn -f "%ROOT%\runtime-java\pom.xml" clean deploy
...
COPY "%ROOT%\cli\bin\Release\Hime.CLI.%VERSION%.nupkg"                             "%RELENG%\hime-%VERSION%\nuget\Hime.CLI.%VERSION%.nupkg"
COPY "%ROOT%\cli\bin\Release\Hime.CLI.%VERSION%.symbols.nupkg"                     "%RELENG%\hime-%VERSION%\nuget\Hime.CLI.%VERSION%.symbols.nupkg"
...
COPY "%ROOT%\himecc\bin\Release\net20\publish\Hime.CLI.dll"                        "%RELENG%\hime-%VERSION%\net20\Hime.CLI.dll"
COPY "%ROOT%\himecc\bin\Release\net20\publish\Hime.CLI.pdb"                        "%RELENG%\hime-%VERSION%\net20\Hime.CLI.pdb"
...
COPY "%ROOT%\cli\bin\Release\net20\Hime.CLI.xml"                                   "%RELENG%\hime-%VERSION%\net20\Hime.CLI.xml"
...
COPY "%ROOT%\himecc\bin\Release\net461\publish\Hime.CLI.dll"                       "%RELENG%\hime-%VERSION%\net461\Hime.CLI.dll"
COPY "%ROOT%\himecc\bin\Release\net461\publish\Hime.CLI.pdb"                       "%RELENG%\hime-%VERSION%\net461\Hime.CLI.pdb"
...
COPY "%ROOT%\himecc\bin\Release\netcoreapp2.0\publish\Hime.CLI.dll"                "%RELENG%\hime-%VERSION%\netcore20\Hime.CLI.dll"
COPY "%ROOT%\himecc\bin\Release\netcoreapp2.0\publish\Hime.CLI.pdb"                "%RELENG%\hime-%VERSION%\netcore20\Hime.CLI.pdb"
...
COPY "%ROOT%\cli\bin\Release\netstandard2.0\Hime.CLI.xml"                          "%RELENG%\hime-%VERSION%\netcore20\Hime.CLI.xml"
