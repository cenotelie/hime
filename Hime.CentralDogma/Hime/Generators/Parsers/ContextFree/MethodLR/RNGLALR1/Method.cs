namespace Hime.Generators.Parsers.ContextFree.LR
{
    ...
    /// </summary>
    public class MethodRNGLALR1 : CFGrammarMethod
    {
        /// <summary>
                ...
                foreach (LRItemLALR1 Item in Set.Items)
                {
                    ...
                    foreach (Terminal Lookahead in Item.Lookaheads)
                    {
                        ...
                        else // No conflict
                        {
                            ...
                            p_ActionReductions.Add(new LRItemSetActionRNReduce(Lookahead, Item.BaseRule, Item.DotPosition));
                        }
                    }
                }
            }
