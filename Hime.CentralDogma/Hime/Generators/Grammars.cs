namespace Hime.Generators.Parsers
{
    ...
    public abstract class Grammar : Hime.Kernel.Symbol
    {
        ...
        public abstract System.Xml.XmlNode GenerateXMLNode(System.Xml.XmlDocument Document, GrammarParseMethod MethodName, Hime.Kernel.Reporting.Reporter Log, bool DrawVisual);
        public abstract bool GenerateParser(string Namespace, GrammarParseMethod MethodName, string File, Hime.Kernel.Reporting.Reporter Log);
        public abstract bool GenerateParser(string Namespace, GrammarParseMethod MethodName, string File, Hime.Kernel.Reporting.Reporter Log, bool DrawVisual);
