...
{
    public sealed class CFRuleBody : RuleBody
    {
        ...
        public CFRuleBody(GrammarSymbol symbol) : base(symbol) { firsts = new TerminalSet(); }
        ...
        public override GrammarSymbol GetSymbolAt(int index)
        {
        ...
        private bool ComputeFirsts_Choice(int index)
        {
            ...
            GrammarSymbol symbol = choice.parts[0].Symbol;
