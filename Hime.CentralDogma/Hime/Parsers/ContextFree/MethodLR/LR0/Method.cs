namespace Hime.Parsers.CF.LR
{
    ...
    /// </summary>
    public class MethodLR0 : CFParseMethod
    {
        /// <summary>
            ...
            public void Build(LRItemSet Set)
            {
                ...
                foreach (LRItem Item in Set.Items)
                {
                    ...
                    if (Set.Children.Count != 0)
                    {
                        ...
                        LRConflict Conflict = new LRConflict(typeof(MethodLR0), LRConflictType.ShiftReduce);
                    ...
                    if (Reduce != null)
                    {
                        ...
                        LRConflict Conflict = new LRConflict(typeof(MethodLR0), LRConflictType.ReduceReduce);
                        Conflict.AddItem(Item);
