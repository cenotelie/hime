namespace Hime.Parsers.CF.LR
{
    ...
    /// </summary>
    public class MethodLR1 : CFParseMethod
    {
        /// <summary>
        ...
        internal class SetActions : ILRItemSetActions
        {
            ...
            public static void HandleConflict_ShiftReduce(System.Collections.Generic.List<LRConflict> Conflicts, LRItem ConflictuousItem, LRItemSet Set, Terminal Lookahead)
            {
                ...
                LRConflict Conflict = new LRConflict(typeof(MethodLR1), LRConflictType.ShiftReduce, Lookahead);
            ...
            public static void HandleConflict_ReduceReduce(System.Collections.Generic.List<LRConflict> Conflicts, LRItem ConflictuousItem, LRItem PreviousItem, LRItemSet Set, Terminal Lookahead)
            {
                ...
                // No previous conflict was found
                LRConflict Conflict = new LRConflict(typeof(MethodLR1), LRConflictType.ReduceReduce, Lookahead);
        ...
        {
            Log.Info("LR(1)", "Constructing LR(1) data ...");
            p_Grammar = Grammar;
        ...
        public static LRGraph ConstructGraph(CFGrammar Grammar, Hime.Kernel.Reporting.Reporter Log)
        {
            ...
            for (int i = 0; i != Graph.Sets.Count; i++)
            {
                ...
                Graph.Sets[i].ID = i;
                Log.Info("LR(1)", "Set I" + i.ToString() + " on " + Graph.Sets.Count.ToString() + " completed");
            }
