...
namespace Hime.HimeCC
{
	...
	internal class CommandLineParser : LRkParser
	{
		...
		public class ID
		{
			...
			/// </summary>
			public const int VariableValue = 0x0009;
			/// <summary>
			/// The unique identifier for variable argument
			/// </summary>
			public const int VariableArgument = 0x000A;
			/// <summary>
			/// The unique identifier for variable values
			/// </summary>
			public const int VariableValues = 0x000B;
			/// <summary>
			/// The unique identifier for variable arguments
			/// </summary>
			public const int VariableArguments = 0x000C;
			/// <summary>
			/// The unique identifier for variable line
			/// </summary>
			public const int VariableLine = 0x000D;
		}
		/// <summary>
