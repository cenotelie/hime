...
const TERMINALS: &'static [Symbol] = &[
    ...
    Symbol { id: 0x0009, name: "NAME" },
    Symbol { id: 0x0008, name: "NAME_FIRST" },
    Symbol { id: 0x000D, name: "LITERAL_ANY" },
    Symbol { id: 0x0014, name: "OPERATOR_OPTIONAL" },
    Symbol { id: 0x0015, name: "OPERATOR_ZEROMORE" },
    Symbol { id: 0x0016, name: "OPERATOR_ONEMORE" },
    Symbol { id: 0x0017, name: "OPERATOR_UNION" },
    Symbol { id: 0x0018, name: "OPERATOR_DIFFERENCE" },
    Symbol { id: 0x0019, name: "TREE_ACTION_PROMOTE" },
    Symbol { id: 0x001A, name: "TREE_ACTION_DROP" },
    ...
    Symbol { id: 0x005D, name: ":" },
    Symbol { id: 0x0007, name: "SEPARATOR" },
    Symbol { id: 0x0003, name: "NEW_LINE" },
    Symbol { id: 0x0004, name: "WHITE_SPACE" },
    Symbol { id: 0x000A, name: "INTEGER" },
    Symbol { id: 0x000C, name: "LITERAL_STRING" },
    Symbol { id: 0x0013, name: "UNICODE_SPAN_MARKER" },
    Symbol { id: 0x004E, name: "->" },
    Symbol { id: 0x000B, name: "ESCAPEES" },
    Symbol { id: 0x0005, name: "COMMENT_LINE" },
    Symbol { id: 0x0012, name: "UNICODE_CODEPOINT" },
    Symbol { id: 0x000F, name: "LITERAL_CLASS" },
    Symbol { id: 0x000E, name: "LITERAL_TEXT" },
    Symbol { id: 0x0006, name: "COMMENT_BLOCK" },
    Symbol { id: 0x0010, name: "UNICODE_BLOCK" },
    Symbol { id: 0x0011, name: "UNICODE_CATEGORY" },
    Symbol { id: 0x001D, name: "BLOCK_RULES" },
    Symbol { id: 0x001B, name: "BLOCK_OPTIONS" },
    Symbol { id: 0x001E, name: "BLOCK_CONTEXT" },
    Symbol { id: 0x005F, name: "grammar" },
    Symbol { id: 0x004F, name: "fragment" },
    Symbol { id: 0x001C, name: "BLOCK_TERMINALS" }];
...
const VARIABLES: &'static [Symbol] = &[
    Symbol { id: 0x001F, name: "option" },
    Symbol { id: 0x0020, name: "terminal_def_atom" },
    Symbol { id: 0x0021, name: "terminal_def_element" },
    Symbol { id: 0x0022, name: "terminal_def_cardinalilty" },
    Symbol { id: 0x0023, name: "terminal_def_repetition" },
    Symbol { id: 0x0024, name: "terminal_def_fragment" },
    Symbol { id: 0x0025, name: "terminal_def_restrict" },
    Symbol { id: 0x0026, name: "terminal_definition" },
    Symbol { id: 0x0027, name: "terminal_rule" },
    Symbol { id: 0x0028, name: "terminal_fragment" },
    Symbol { id: 0x0029, name: "terminal_context" },
    Symbol { id: 0x002A, name: "terminal_item" },
    Symbol { id: 0x002B, name: "rule_sym_action" },
    Symbol { id: 0x002C, name: "rule_sym_virtual" },
    Symbol { id: 0x002D, name: "rule_sym_ref_params" },
    Symbol { id: 0x002E, name: "rule_sym_ref_template" },
    Symbol { id: 0x002F, name: "rule_sym_ref_simple" },
    Symbol { id: 0x0030, name: "rule_def_atom" },
    Symbol { id: 0x0031, name: "rule_def_context" },
    Symbol { id: 0x0032, name: "rule_def_element" },
    Symbol { id: 0x0033, name: "rule_def_tree_action" },
    Symbol { id: 0x0034, name: "rule_def_repetition" },
    Symbol { id: 0x0035, name: "rule_def_fragment" },
    Symbol { id: 0x0036, name: "rule_def_choice" },
    Symbol { id: 0x0037, name: "rule_definition" },
    Symbol { id: 0x0038, name: "rule_template_params" },
    Symbol { id: 0x0039, name: "cf_rule_template" },
    Symbol { id: 0x003A, name: "cf_rule_simple" },
    Symbol { id: 0x003B, name: "cf_rule" },
    Symbol { id: 0x003C, name: "grammar_options" },
    Symbol { id: 0x003D, name: "grammar_terminals" },
    Symbol { id: 0x003E, name: "grammar_cf_rules" },
    Symbol { id: 0x003F, name: "grammar_parency" },
    Symbol { id: 0x0040, name: "cf_grammar" },
    Symbol { id: 0x0041, name: "file" },
    Symbol { id: 0x004B, name: "__V75" },
    Symbol { id: 0x004C, name: "__V76" },
    Symbol { id: 0x004D, name: "__V77" },
    Symbol { id: 0x0050, name: "__V80" },
    Symbol { id: 0x0053, name: "__V83" },
    Symbol { id: 0x0056, name: "__V86" },
    Symbol { id: 0x0058, name: "__V88" },
    Symbol { id: 0x0059, name: "__V89" },
    Symbol { id: 0x005A, name: "__V90" },
    Symbol { id: 0x005B, name: "__V91" },
    Symbol { id: 0x005C, name: "__V92" },
    Symbol { id: 0x005E, name: "__V94" },
    Symbol { id: 0x0060, name: "__V96" },
    Symbol { id: 0x0061, name: "__VAxiom" }];

/// The collection of virtuals matched by this parser
/// The virtuals are in an order consistent with the automaton,
/// so that virtual indices in the automaton can be used to retrieve the virtuals in this table
const VIRTUALS: &'static [Symbol] = &[
    Symbol { id: 0x0046, name: "range" },
    Symbol { id: 0x004A, name: "concat" },
    Symbol { id: 0x0057, name: "emptypart" }];
