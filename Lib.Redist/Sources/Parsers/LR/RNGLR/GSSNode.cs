...
namespace Hime.Redist.Parsers
{
	...
	{
		/// <summary>
		/// The initial size of the edge buffer
		/// </summary>
		private const int initEdgesCount = 5;

		/// <summary>
		/// The parent generation of this node
		/// </summary>
		private GSSGeneration generation;
		/// <summary>
		/// The RNGLR state represented by this node
		/// </summary>
		private int state;
		/// <summary>
		...
		/// <returns><c>true</c> if this node has a edge to the given node</returns>
