...
namespace Hime.Redist.Parsers
{
	...
	class GSSGeneration : IEnumerable<GSSNode>
	{
		...
		private int size;
		/// <summary>
		/// The nodes in this generation
		/// </summary>
		private GSSNode[] data;
		/// <summary>
		/// The marking buffer of this generation
		/// </summary>
		...
		/// <returns><c>true</c> if there is a node, false otherwise</returns>
		...
		public IEnumerator<GSSNode> GetEnumerator()
		{
