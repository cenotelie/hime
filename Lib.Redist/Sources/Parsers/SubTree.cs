...
namespace Hime.Redist.Parsers
{
    ...
    class SubTree
    {
        ...
        public TreeAction GetActionAt(int index) { return actions[index]; }
        ...
        public void SetActionAt(int index, TreeAction action) { actions[index] = action; }
        ...
        public int GetChildrenCountAt(int index) { return nodes[index].count; }
        ...
        public void SetChildrenCountAt(int index, int count) { nodes[index].count = count; }
