...
pub const ID_TERMINAL_NODE_NAME: u32 = 0x002E;
...
pub fn visit_ast_node(node: AstNode, visitor: &dyn Visitor) {
    ...
    match node.get_symbol().id {
        ...
        0x002E => visitor.on_terminal_node_name(&node),
        0x003B => visitor.on_variable_option(&node),
        0x003C => visitor.on_variable_terminal_def_atom(&node),
        0x003D => visitor.on_variable_terminal_def_element(&node),
        0x003E => visitor.on_variable_terminal_def_cardinalilty(&node),
        0x003F => visitor.on_variable_terminal_def_repetition(&node),
        0x0040 => visitor.on_variable_terminal_def_fragment(&node),
        0x0041 => visitor.on_variable_terminal_def_restrict(&node),
        0x0042 => visitor.on_variable_terminal_definition(&node),
        0x0043 => visitor.on_variable_terminal_rule(&node),
        0x0044 => visitor.on_variable_terminal_fragment(&node),
        0x0045 => visitor.on_variable_terminal_context(&node),
        0x0046 => visitor.on_variable_terminal_item(&node),
        0x0047 => visitor.on_variable_rule_sym_action(&node),
        0x0048 => visitor.on_variable_rule_sym_virtual(&node),
        0x0049 => visitor.on_variable_rule_sym_ref_params(&node),
        0x004A => visitor.on_variable_rule_sym_ref_template(&node),
        0x004B => visitor.on_variable_rule_sym_ref_simple(&node),
        0x004C => visitor.on_variable_rule_def_atom(&node),
        0x004D => visitor.on_variable_rule_def_context(&node),
        0x004E => visitor.on_variable_rule_def_sub(&node),
        0x004F => visitor.on_variable_rule_def_element(&node),
        0x0050 => visitor.on_variable_rule_def_tree_action(&node),
        0x0051 => visitor.on_variable_rule_def_repetition(&node),
        0x0052 => visitor.on_variable_rule_def_fragment(&node),
        0x0053 => visitor.on_variable_rule_def_choice(&node),
        0x0054 => visitor.on_variable_rule_definition(&node),
        0x0055 => visitor.on_variable_rule_template_params(&node),
        0x0056 => visitor.on_variable_cf_rule_template(&node),
        0x0057 => visitor.on_variable_cf_rule_simple(&node),
        0x0058 => visitor.on_variable_cf_rule(&node),
        0x0059 => visitor.on_variable_grammar_options(&node),
        0x005A => visitor.on_variable_grammar_terminals(&node),
        0x005B => visitor.on_variable_grammar_cf_rules(&node),
        0x005C => visitor.on_variable_grammar_parency(&node),
        0x005D => visitor.on_variable_cf_grammar(&node),
        0x005E => visitor.on_variable_file(&node),
        0x006C => visitor.on_variable_fixture(&node),
        0x006D => visitor.on_variable_header(&node),
        0x006E => visitor.on_variable_test(&node),
        0x006F => visitor.on_variable_test_matches(&node),
        0x0070 => visitor.on_variable_test_no_match(&node),
        0x0071 => visitor.on_variable_test_fails(&node),
        0x0072 => visitor.on_variable_test_output(&node),
        0x0073 => visitor.on_variable_tree(&node),
        0x0074 => visitor.on_variable_check(&node),
        0x0075 => visitor.on_variable_children(&node),
        0x0038 => visitor.on_virtual_range(&node),
        0x0039 => visitor.on_virtual_concat(&node),
        0x003A => visitor.on_virtual_emptypart(&node),
        _ => ()
    };
}
